...
$Host.UI.RawUI.WindowTitle = "Correção erro de internet (SpectreKeys("
...
function Write-Header {
    ...
    Write-Host "  |           CORRIGIR BUGS DE INTERNET (SpectreKeys)              |" -ForegroundColor Cyan
    Write-Host "  |            Utilize para Corrigir erros de internet.            |" -ForegroundColor Cyan
    Write-Host "  |                                                                |" -ForegroundColor Cyan
